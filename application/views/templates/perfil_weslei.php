...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row m-b-lg m-t-lg">
            ...
            <div class="ibox-content text-center">
                ...
                <div class="largura col-xs-12">
                    <div class="profile-image">
                        <img src="img/weslei-nova.png" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
                </div>
                <h2>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <h3><strong><?php echo "R$", number_format($contas_weslei['0']['total_vendido']/$contas_weslei['0']['contas_vendidas'],2, ',' , '.')   ?></strong></h3>
                        </td>
                        <td>
                            <h4>% da Meta
                                <p>
                            </h4>
                            <h3><strong><?php echo round($contas_weslei['0']['total_vendido']*100/6000) , "%" ?></strong></h3>
                        </td>
                        <td>
                            <h4> Meta
                                <p>
                            </h4>
                            <h3><strong>R$6.000,00</strong></h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <h3><strong><?php echo $contas_weslei['0']['contas_vendidas'] ?> </strong></h3>
                        </td>
                        <td>
                            <h4>Nº Ranking MRR
                                <p>
                    ...
                    <tr>
                        <td>
                            ...
                            <h3><strong><?php echo "R$", number_format($weslei05+$contas_weslei['0']['total_vendido'],2, ',' , '.')?></strong> </h3>
                        </td>
                        <td>
                            <h4>Média de Venda</h4>
                            <h3><strong><?php echo "R$", number_format(($weslei05+$contas_weslei['0']['total_vendido'])/6,2, ',' , '.')?></strong></h3>
                        </td>

                        <td>
                            <h4>Total de Contas Vendidas</h4>
                            <h3><strong><?php echo $contas_weslei['0']['contas_vendidas']+$wesleiContas ?></strong></h3>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="col-md-3">
            ...
            <h2 class="no-margins">
                <?php echo "R$", number_format($contas_weslei['0']['total_vendido'],2, ',' , '.')?>
            </h2>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="clients-list">
                            <ul class="nav nav-tabs">
                                <span class="pull-right small text-muted"><?php echo $contas_weslei['0']['contas_vendidas']," Contas Vendidas" ?></span>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                <tbody>
                                                    <?php foreach ($weslei as $dados):?>
                                                    <tr>
                                                        <td class="client-avatar"><img alt="image" src="img/weslei-nova.png"> </td>
                                                        <td>
